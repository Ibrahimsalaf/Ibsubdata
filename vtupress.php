...
add_action('user_register','vtupress_register');

function vtupress_register($userid){
  //do your stuff
  ...
  $usernm = get_userdata($userid)->user_login;
...
add_action('user_register', 'vrpl');

function vrpl($user_id){
...
$next = date("Y-m-d H:i A");
  ...
  maybe_add_column($lsd_name,"upgrade_pv", "ALTER TABLE $lsd_name ADD upgrade_pv text");
